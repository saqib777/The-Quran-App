...
![System architecture — Electron loads one HTML file, which already contains all its data](images/diagram1_architecture.png)
...
![Entity–relationship diagram of the app's content](images/diagram3_er.png)
...
![What happens from picking a Surah to reading its Tafsir](images/diagram2_ayah_flow.png)
...
![How a Hadith collection is filtered and paged](images/diagram4_hadith_flow.png)
